                                ...
                                <table className="w-full text-sm text-slate-700 min-w-[1100px]">
                                    <thead>
                                        <tr className="bg-slate-50 sticky top-0">
                                            ...
                                            <th className="px-6 py-4 text-left font-semibold text-slate-700">Website</th>
                                            ...
                                            <th className="px-6 py-4 text-left font-semibold text-slate-700">State</th>
                                    ...
                                    <tbody>
                                        {contacts.map((contact) => (
                                            ...
                                            >
                                                ...
                                                <td className="px-6 py-4">{formatDate(contact.created_at)}</td>
                                                <td className="px-6 py-4">
