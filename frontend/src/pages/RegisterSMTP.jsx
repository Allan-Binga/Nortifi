                              ...
                              <ul className="absolute mt-2 w-full rounded-xl bg-white shadow-lg border border-blue-100 z-10 animate-fadeIn">
                                {PORT_OPTIONS.map((option) => (
                                  <li
                                    ...
                                    className={`px-4 py-3 cursor-pointer hover:bg-amber-50 hover:text-amber-700 transition-colors ${smtpData.port === option.value
                ...
                {formStep === 2 && (
                  <div className="space-y-6">
                    ...
                    <button
                      ...
                      className={`w-full bg-gray-900 text-white px-6 py-3 rounded-md flex items-center justify-center space-x-2 transition-all ${statusStep !== "idle"
